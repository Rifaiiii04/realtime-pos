...
export default function AppSidebar() {
  ...
  return (
    ...
    >
          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild>
              <div className="font-bold">
                <div className="bg-teal-500 text-primary-foreground flex p-2 items-center justify-center rounded-md">
                  <Coffee className="size-" />
                </div>
                FAI Cafe
              </div>
            </SidebarMenuButton>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupContent className="flex col-1 gap-2">
            <SidebarMenu>
